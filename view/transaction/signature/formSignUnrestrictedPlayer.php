...
?>
<form action="index.php?section=sign_player&id=<?php echo $_GET['id'];?>&submit=yes&match=yes" method="post">
...
<form action="index.php?section=sign_player&id=<?php echo $_GET['id'];?>&submit=yes&match=no" method="post">
